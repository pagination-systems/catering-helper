        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href={tenant.social.instagram} className="text-muted-foreground transition hover:text-red-500">
              ...
              <a href={tenant.social.youtube} className="text-muted-foreground transition hover:text-red-500">
